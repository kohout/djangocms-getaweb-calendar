...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'EventCategory.name'
        db.alter_column(u'djangocms_calendar_eventcategory', 'name', self.gf('django.db.models.fields.CharField')(max_length=30))

    def backwards(self, orm):

        # Changing field 'EventCategory.name'
        db.alter_column(u'djangocms_calendar_eventcategory', 'name', self.gf('django.db.models.fields.CharField')(max_length=20))
